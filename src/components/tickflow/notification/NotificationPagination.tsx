...
export const NotificationPagination: Component<{ pageNumberMax: number }> = ({ pageNumberMax }) => {
  const { notificationParam, queryNotificationParam } = useQueryNotification();
  const { activePage, inputPage, setActivePage, setInputPage } = useNotificationGeneralStore();
